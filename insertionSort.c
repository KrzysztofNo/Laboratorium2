...
void insertionSort(int array[]) //deklarujemy funkcje z argumentem
{
    for(int b=1;b<15;b++) //petla, ktora inkrementuje wszystkie elementy tablicy z pominieciem pierwszego
    {
        ...
        {
            array[j+1]=array[j]; //przypisanie kolejnego elementu tablicy do poprzedniego
        j--;
